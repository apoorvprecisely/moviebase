...
<html>
<head>
<title>Castleshare.com|Share Your Collection</title>
  ...
  <tr> 
    ...
    <td width="562" valign="top"><p>&nbsp;</p>
      ...
      <form action="index.php" method="post" name="logForm" id="logForm" >
        ...
        <table width="30%" align="center" border="0" cellpadding="4" cellspacing="4" class="loginform">
          <tr> 
            <td colspan="2">&nbsp;</td>
          </tr>
          <tr> 
