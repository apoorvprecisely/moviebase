...
define ("DB_USER", "castlesh_root"); // set database user
define ("DB_PASS","apoorv"); // set database password
define ("DB_NAME","castlesh_jack"); // set database name
...
/* Secure against Session Hicastlesh_jacking by checking user agent */
